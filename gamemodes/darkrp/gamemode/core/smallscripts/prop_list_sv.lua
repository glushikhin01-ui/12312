...
function GM:PlayerSwitchFlashlight(ply, SwitchOn) return true end -- Это выключает фонарик
...
function GM:PlayerSpawnProp(ply, mdl)
	...
	if table.HasValue(({"models/props_phx/construct/metal_plate1.mdl",
		...
		//  halloween
			...
			"models/zerochain/props_halloween/mexicanskull.mdl"}), mdl) then
		return true
	end
	
	ply.Notify(ply, NOTIFY_ERROR, term.Get('PropNotWhitelisted'), mdl)
	return ply:HasAccess('e')
end
