...
surface.CreateFont("Keypad", {font = 'Roboto', size = 34, weight = 900})
surface.CreateFont("KeypadState", {font = 'Roboto', size = 20, weight = 600})
surface.CreateFont("KeypadButton", {font = 'Roboto', size = 24, weight = 500})
surface.CreateFont("KeypadSButton", {font = 'Roboto', size = 16, weight = 900})
