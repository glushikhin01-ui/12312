...
function ENT:Initialize()
	...
	self:EmitSound("poco/songpoco.ogg")
	local i = 0
...
function ENT:Explosion()
	...
	local shake = ents.Create("env_shake")
		...
		shake:SetKeyValue("amplitude", "0")	// Power of the shake
		shake:SetKeyValue("radius", "20")		// Radius of the shake
		shake:SetKeyValue("duration", "2.5")	// Time of shake
		shake:SetKeyValue("frequency", "125")	// How har should the screenshake be
