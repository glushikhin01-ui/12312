...
--]]
CH_CryptoCurrencies.Config.Language = "ru" -- Set the language of the script.

--[[
	Default Config
--]]
CH_CryptoCurrencies.Config.NotificationTime = 8 -- Amount of seconds to show notifications
CH_CryptoCurrencies.Config.DistanceTo3D2D = 500000 -- Distance between the player and the 3d2d to draw
...
CH_CryptoCurrencies.Config.ExchangeRateCurrency = "RUB"
