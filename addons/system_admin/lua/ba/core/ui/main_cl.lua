...
surface.CreateFont('ba.ui.24', {font = 'roboto', size = 24, weight = 400, extended = true})
surface.CreateFont('ba.ui.22', {font = 'roboto', size = 22, weight = 400, extended = true})
surface.CreateFont('ba.ui.20', {font = 'roboto', size = 20, weight = 400, extended = true})
surface.CreateFont('ba.ui.18', {font = 'roboto', size = 18, weight = 400, extended = true})
surface.CreateFont('ba.ui.17', {font = 'roboto', size = 17, weight = 400, extended = true})
