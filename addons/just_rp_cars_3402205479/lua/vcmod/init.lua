...
if !VC then VC = {} end if !VC.Versions then VC.Versions = {} end if !VC.Loaded then VC.Loaded = {} end if !VC.AddonData then VC.AddonData = {} end VC.Copyright = "Copyright © 2012-2018 VCMod (freemmaann)." VC.Host = "http://vcmod.org/" if !VC.AUMsg then VC.AUMsg = {} end file.CreateDir("vcmod")
