...
sound.Add( {
	...
	level = 75,
	pitch = { 95, 110 },
	sound =	{ "vehicles/tdmcars/miscsounds/engine_off.ogg", "vehicles/tdmcars/miscsounds/engine_off2.ogg", "vehicles/tdmcars/miscsounds/engine_off2.ogg", "vehicles/tdmcars/miscsounds/engine_off2.ogg" },
} )
end
