...
function EFFECT:Init(data)
	...
	ParticleEffectAttach("ww2_flamethrower_long", PATTACH_POINT_FOLLOW, self.WeaponEnt, data:GetAttachment())   
	...
	if GetConVar("cl_tfa_codww2k_dlights"):GetBool() then
    	local dlight
    	...
    	if (dlight) then
    		dlight.Pos = self.Position + dir * 16 - dir:Angle():Right() * 5
    		dlight.r = 235
			dlight.g = 75
			dlight.b = 15
    		dlight.brightness = 1
