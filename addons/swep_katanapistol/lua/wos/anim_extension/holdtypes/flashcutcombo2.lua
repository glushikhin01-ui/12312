...
DATA.Translations[ ACT_MP_ATTACK_STAND_PRIMARYFIRE ]	= "wos_ryoku_h_left_t2" 
DATA.Translations[ ACT_MP_ATTACK_CROUCH_PRIMARYFIRE ]	= "wos_ryoku_h_left_t2" 
