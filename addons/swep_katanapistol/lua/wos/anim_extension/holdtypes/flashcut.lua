...
DATA.Translations[ ACT_MP_ATTACK_STAND_PRIMARYFIRE ]	= "wos_judge_r_right_t1" 
DATA.Translations[ ACT_MP_ATTACK_CROUCH_PRIMARYFIRE ]	= "wos_judge_r_right_t1" 
