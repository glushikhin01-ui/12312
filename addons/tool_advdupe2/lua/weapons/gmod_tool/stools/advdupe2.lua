...
if(SERVER)then
	...
	function TOOL:LeftClick( trace )
		...
		local z = math.Clamp(((tonumber(ply:GetInfo("advdupe2_offset_z")) or 0) + ply.AdvDupe2.HeadEnt.Z), -32000, 32000)
...
if(CLIENT)then
	...
	function TOOL:Holster()
		...
		if AdvDupe2.RemoveSelectBox then AdvDupe2.RemoveSelectBox() end
	...
	local rate
	surface.CreateFont ("AD2Font", {font="Arial", size=40, weight=1000})
