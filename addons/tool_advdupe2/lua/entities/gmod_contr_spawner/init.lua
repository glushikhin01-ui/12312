...
function ENT:UpdateOptions( ply, options )
	self:SetOptions( ply, options["delay"], options["undo_delay"], options["key"], options["undo_key"], options["disgrav"], options["disdrag"], options["addvel"], options["hideprops"])
end
