function AdvDupe2.LoadGhosts(dupe, info, moreinfo, name, preview)
	...
	if(not preview) then
		if AdvDupe2.Info then
			...
			AdvDupe2.InfoText.File = "File: "..name
			AdvDupe2.InfoText.Creator = "Creator: "..creator
			AdvDupe2.InfoText.Date = "Date: "..date
			AdvDupe2.InfoText.Time = "Time: "..time
			AdvDupe2.InfoText.Size = "Size: "..string.NiceSize(tonumber(info.size) or 0)
			AdvDupe2.InfoText.Desc = "Desc: "..(desc or "")
			AdvDupe2.InfoText.Entities = "Entities: "..table.Count(dupe.Entities)
			AdvDupe2.InfoText.Constraints = "Constraints: "..table.Count(dupe.Constraints)
		end
	end
