...
if SERVER then 
    ...
    AddCSLuaFile("advanced_accessories/client/cl_newui.lua")
    ...
    AddCSLuaFile("advanced_accessories/vgui/cl_newsearch.lua")
    ...
    include("advanced_accessories/client/cl_newui.lua")
    ...
    include("advanced_accessories/vgui/cl_newsearch.lua")
