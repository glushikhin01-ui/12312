...
function ENT:Draw()
	...
	cam.Start3D2D( self:GetPos() + self:GetUp() * 95, Angle( 0, AngEyes.y - 90, 90 ), 0.08 )
		draw.RoundedBox( 6, -140, 40, 350, 110, color_gray_trans )


		draw.SimpleText( 'Банкомат', "MSB_30", -120, 80, color_white, TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER )
