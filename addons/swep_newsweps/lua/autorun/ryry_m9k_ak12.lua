...
sound.Add({
	...
	channel = 		CHAN_ITEM,
	volume = 		1.0,
	sound = 			"weapons/ak12/boltpull.wav"
})
//Deagle
sound.Add({
	name = 			"ryak.Foley",
...
sound.Add({
	...
	channel = 		CHAN_ITEM,
	volume = 		1.0,
	sound = 			"weapons/ak12/shoulder.wav"
})
