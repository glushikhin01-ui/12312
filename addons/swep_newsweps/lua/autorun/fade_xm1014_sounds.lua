...
if CLIENT then
       killicon.Add(  "csgo_fade_xm1014",		"vgui/hud/csgo_fade_xm1014", icol  )
       killicon.Add(  "tfa_csgo_fade_xm1014",		"vgui/hud/csgo_fade_xm1014", icol  )
...
//CSGO XM1014 Fade
sound.Add({
	name = 			"Fadeee_xm1014.InsertShell",
	channel = 		CHAN_USER_BASE+10,
	volume = 		1.0,
	sound = 			"weapons/xm1014_fade/xm1014_insertshell.wav"
})

sound.Add({
	name = 			"Fadeee_xm1014.Deploy",
	channel = 		CHAN_ITEM,
	volume = 		1.0,
	sound = 			"weapons/xm1014_fade/draw.wav"
})

sound.Add({
	name = 			"Fadeee_xm1014.Boltpull",
	channel = 		CHAN_ITEM,
	volume = 		1.0,
	sound = 			"weapons/xm1014_fade/boltpull.wav"
})
