...
if CLIENT then
	...
	killicon.Add(  "avenger_xr2",		"vgui/hud/avenger_xr2", icol  )
...
//weapon name
sound.Add({
	name = 			"avenger_xr2_shoot",
	channel = 		CHAN_USER_BASE+10, --see how this is a different channel? Gunshots go here
	volume = 		1.0,
	sound = 			{"weapons/avenger_xr2/m4a1_unsil-1.wav",
						"weapons/avenger_xr2/m4a1_unsil-2.wav"}
})

sound.Add({
	name = 			"avenger_xr2_silent",
	channel = 		CHAN_USER_BASE+10, --see how this is a different channel? Gunshots go here
	volume = 		1.0,
	sound = 			{"weapons/avenger_xr2/m4a1-1.wav",
						"weapons/avenger_xr2/m4a1-2.wav"}
})

sound.Add({
	name = 			"pew_avgrxr2.Clipout",
	channel = 		CHAN_ITEM,
	volume = 		1.0,
	sound = 			"weapons/avenger_xr2/m4a1_clipout.wav"
})

sound.Add({
	name = 			"pew_avgrxr2.Clipin",
	channel = 		CHAN_ITEM,
	volume = 		1.0,
	sound = 			"weapons/avenger_xr2/m4a1_clipin.wav"
})

sound.Add({
	name = 			"pew_avgrxr2.Magtap",
	channel = 		CHAN_ITEM,
	volume = 		1.0,
	sound = 			"weapons/avenger_xr2/m4a1_magtap.wav"
})

sound.Add({
	name = 			"pew_avgrxr2.Boltrelease",
	channel = 		CHAN_ITEM,
	volume = 		1.0,
	sound = 			"weapons/avenger_xr2/m4a1_boltrelease.wav"
})

sound.Add({
	name = 			"pew_avgrxr2.Silencer_On",
	channel = 		CHAN_ITEM,
	volume = 		1.0,
	sound = 			"weapons/avenger_xr2/m4a1_silencer_on.wav"
})

sound.Add({
	name = 			"pew_avgrxr2.Silencer_Off",
	channel = 		CHAN_ITEM,
	volume = 		1.0,
	sound = 			"weapons/avenger_xr2/m4a1_silencer_off.wav"
})
