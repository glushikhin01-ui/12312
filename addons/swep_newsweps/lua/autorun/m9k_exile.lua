...
if CLIENT then
	killicon.Add( "m9k_gdcwa_exile_90mm", "vgui/hud/m9k_exiled", Color( 255, 255, 255, 255 )  )
	killicon.Add( "m9k_exile", "vgui/hud/m9k_exiled", Color( 255, 255, 255, 255 )  )
end
...
m9knpw = {}
table.insert(m9knpw, "m9k_gdcwa_exile_90mm")
table.insert(m9knpw, "m9k_exile")
