...
if CLIENT then
	...
	killicon.Add(  "tfa_acr",		"vgui/hud/tfa_acr", icol  )
	killicon.Add(  "tfa_ak47",		"vgui/hud/tfa_ak47", icol  )
	killicon.Add(  "tfa_ak74",		"vgui/hud/tfa_ak74", icol  )
	killicon.Add(  "tfa_amd65", 	"vgui/hud/tfa_amd65", icol )
	killicon.Add(  "tfa_an94", 		"vgui/hud/tfa_an94", icol )
	killicon.Add(  "tfa_auga3",		"vgui/hud/tfa_auga3", icol  )
	killicon.Add(  "tfa_f2000",		"vgui/hud/tfa_f2000", icol )
	killicon.Add(  "tfa_fal",		"vgui/hud/tfa_fal", icol )
	killicon.Add(  "tfa_famas",		"vgui/hud/tfa_famas", icol  )
	killicon.Add(  "tfa_g3a3",		"vgui/hud/tfa_g3a3", icol )
	killicon.Add(  "tfa_g36", 		"vgui/hud/tfa_g36", icol )
	killicon.Add(  "tfa_l85", 		"vgui/hud/tfa_l85", icol )
	killicon.Add(  "tfa_m4a1", 		"vgui/hud/tfa_m4a1", icol )
	killicon.Add(  "tfa_m14sp", 	"vgui/hud/tfa_m14sp", icol )
	killicon.Add(  "tfa_m16a4_acog", "vgui/hud/tfa_m16a4_acog", icol )
	killicon.Add(  "tfa_m416", 		"vgui/hud/tfa_m416", icol )
	killicon.Add(  "tfa_scar", 		"vgui/hud/tfa_scar", icol )
	killicon.Add(  "tfa_tar21", 	"vgui/hud/tfa_tar21", icol )
	killicon.Add(  "tfa_val", 		"vgui/hud/tfa_val", icol )
	killicon.Add(  "tfa_vikhr", 	"vgui/hud/tfa_vikhr", icol )
	killicon.Add(  "tfa_winchester73", "vgui/hud/tfa_winchester73", icol  )
end
...
tfa_assault_autorun_mounted = true
