...
if CLIENT then
	killicon.Add( "tfa_bizonp19", "vgui/hud/tfa_bizonp19", icol  )
	killicon.Add( "tfa_colt1911", "vgui/hud/tfa_colt1911", icol  )
	killicon.Add( "tfa_coltpython", "vgui/hud/tfa_coltpython", icol  )
	killicon.Add( "tfa_deagle", "vgui/hud/tfa_deagle", icol  )
	killicon.Add( "tfa_glock", "vgui/hud/tfa_glock", icol  )
	killicon.Add( "tfa_hk45", "vgui/hud/tfa_hk45", icol  )
	killicon.Add( "tfa_luger", "vgui/hud/tfa_luger", icol  )
	killicon.Add( "tfa_m29satan", "vgui/hud/tfa_m29satan", icol  )
	killicon.Add( "tfa_m92beretta", "vgui/hud/tfa_m92beretta", icol  )
	killicon.Add( "tfa_model3russian", "vgui/hud/tfa_model3russian", icol  )
	killicon.Add( "tfa_mp7", "vgui/hud/tfa_mp7", icol  )
	killicon.Add( "tfa_ragingbull", "vgui/hud/tfa_ragingbull", icol  )
	killicon.Add( "tfa_remington1858", "vgui/hud/tfa_remington1858", icol  )
	killicon.Add( "tfa_sig_p229r", "vgui/hud/tfa_sig_p229r", icol  )
	killicon.Add( "tfa_smgp90", "vgui/hud/tfa_smgp90", icol  )
	killicon.Add( "tfa_sten", "vgui/hud/tfa_sten", icol  )
	killicon.Add( "tfa_thompson", "vgui/hud/tfa_thompson", icol  )
	killicon.Add( "tfa_usp", "vgui/hud/tfa_usp", icol  )
	killicon.Add( "tfa_uzi", "vgui/hud/tfa_uzi", icol  )
	killicon.Add( "tfa_model500", "vgui/hud/tfa_model500", icol  )
	killicon.Add( "tfa_model627", "vgui/hud/tfa_model627", icol  )
	killicon.Add( "tfa_ump45", "vgui/hud/tfa_ump45", icol  )
	killicon.Add( "tfa_mp9", "vgui/hud/tfa_mp9", icol  )
	killicon.Add( "tfa_vector", "vgui/hud/tfa_vector", icol  )
	killicon.Add( "tfa_tec9", "vgui/hud/tfa_tec9", icol  )
	killicon.Add( "tfa_mp5", "vgui/hud/tfa_mp5", icol  )
	killicon.Add( "tfa_kac_pdw", "vgui/hud/tfa_kac_pdw", icol  )
	killicon.Add( "tfa_honeybadger", "vgui/hud/tfa_honeybadger", icol  )
	killicon.Add( "tfa_mp5sd", "vgui/hud/tfa_mp5sd", icol  )
	killicon.Add( "tfa_magpulpdr", "vgui/hud/tfa_magpulpdr", icol  )
	killicon.Add( "tfa_scoped_taurus", "vgui/hud/tfa_scoped_taurus", icol  )
	killicon.Add( "tfa_mp40", "vgui/hud/tfa_mp40", icol  )
end
//MP40
sound.Add({
	name = 			"mp40.single",
...
tfa_small_autorun_mounted = true
