...
if CLIENT then
	killicon.Add( "tfa_1887winchester", "vgui/hud/tfa_1887winchester", icol  )
	killicon.Add( "tfa_1897winchester", "vgui/hud/tfa_1897winchester", icol  )
	killicon.Add( "tfa_ares_shrike", "vgui/hud/tfa_ares_shrike", icol  )
	killicon.Add( "tfa_aw50", "vgui/hud/tfa_aw50", icol  )
	killicon.Add( "tfa_barret_m82", "vgui/hud/tfa_barret_m82", icol  )
	killicon.Add( "tfa_browningauto5", "vgui/hud/tfa_browningauto5", icol  )
	killicon.Add( "tfa_contender", "vgui/hud/tfa_contender", icol  )
	killicon.Add( "tfa_dbarrel", "vgui/hud/tfa_dbarrel", icol  )
	killicon.Add( "tfa_dragunov", "vgui/hud/tfa_dragunov", icol  )
	killicon.Add( "tfa_fg42", "vgui/hud/tfa_fg42", icol  )
	killicon.Add( "tfa_intervention", "vgui/hud/tfa_intervention", icol  )
	killicon.Add( "tfa_ithacam37", "vgui/hud/tfa_ithacam37", icol  )
	killicon.Add( "tfa_jackhammer", "vgui/hud/tfa_jackhammer", icol  )
	killicon.Add( "tfa_m3", "vgui/hud/tfa_m3", icol  )
	killicon.Add( "tfa_m24", "vgui/hud/tfa_m24", icol  )
	killicon.Add( "tfa_m60", "vgui/hud/tfa_m60", icol  )
	killicon.Add( "tfa_m98b", "vgui/hud/tfa_m98b", icol  )
	killicon.Add( "tfa_m249lmg", "vgui/hud/tfa_m249lmg", icol  )
	killicon.Add( "tfa_m1918bar", "vgui/hud/tfa_m1918bar", icol  )
	killicon.Add( "tfa_minigun", "vgui/hud/tfa_minigun", icol  )
	killicon.Add( "tfa_mossberg590", "vgui/hud/tfa_mossberg590", icol  )
	killicon.Add( "tfa_psg1", "vgui/hud/tfa_psg1", icol  )
	killicon.Add( "tfa_remington870", "vgui/hud/tfa_remington870", icol  )
	killicon.Add( "tfa_remington7615p", "vgui/hud/tfa_remington7615p", icol  )
	killicon.Add( "tfa_sl8", "vgui/hud/tfa_sl8", icol  )
	killicon.Add( "tfa_svu", "vgui/hud/tfa_svu", icol  )
	killicon.Add( "tfa_usas", "vgui/hud/tfa_usas", icol  )
	killicon.Add( "tfa_spas12", "vgui/hud/tfa_spas12", icol  )
	killicon.Add( "tfa_svt40", "vgui/hud/tfa_svt40", icol  )
	killicon.Add( "tfa_striker12", "vgui/hud/tfa_striker12", icol  )
	killicon.Add( "tfa_pkm", "vgui/hud/tfa_pkm", icol  )
...
tfa_heavy_autorun_mounted = true
