...
function TFA.INS2.DrawHoloSight(wep, texture, parent, p, a, s)
	...
	local ViewModelElements = wep:GetStatRawL("ViewModelElements") or {}

	local model
	if isstring(parent) and ViewModelElements[parent] and ViewModelElements[parent].curmodel then
		model = ViewModelElements[parent].curmodel
	end
