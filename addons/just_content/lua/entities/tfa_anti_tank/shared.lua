...
--ds - matveicher
 ...
 ENT.Type 			= "anim"  
 ENT.PrintName			= "High Explosive Anti-Tank RPG / Alt"  
...
self.Entity:SetModel( "models/Weapons/tfa_ins/w_rpg7_projectile.mdl" )
