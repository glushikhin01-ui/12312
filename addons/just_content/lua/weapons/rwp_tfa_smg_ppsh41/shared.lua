...
SWEP.Gun = ("rwp_weapon_smg_ppsh41") -- must be the name of your swep but NO CAPITALS! 
...
sound.Add({
	name = 			"PPSh-41.clipout",
	channel = 		CHAN_ITEM,
	volume = 		1.0,
	sound = 			"Weapons/ppsh41/ppsh-41 out.wav"
})
...
sound.Add({
	...
	channel = 		CHAN_ITEM,
	volume = 		1.0,
	sound = 			"Weapons/ppsh41/clipin.wav"
})

sound.Add({
	name = 			"PPSh-41.boltpull",
	channel = 		CHAN_ITEM,
	volume = 		1.0,
	sound = 			"Weapons/ppsh41/ppsh-41 pull.wav"
})

sound.Add({
	name = 			"PPSh-41.cliprelease",
	channel = 		CHAN_ITEM,
	volume = 		1.0,
	sound = 			"Weapons/ppsh41/ppsh-41 release.wav"
})
