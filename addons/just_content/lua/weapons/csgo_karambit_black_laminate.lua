...
if not file.Exists( 'weapons/csgo_baseknife.lua', 'LUA' ) then
  ...
  print( 'csgo_karambit_black_laminate failed to initialize: csgo_baseknife.lua not found. Did you install the main part?' )
  return 
end
...
SWEP.PrintName      = 'Karambit Knife' .. ' | ' .. 'Black Laminate'
...
SWEP.Icon = "vgui/entities/csgo_karambit_black_laminate.vmt"
