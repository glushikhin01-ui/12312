...
SWEP.PrintName = "Marlboro Full Flavor Pack"
...
SWEP.VElements = {
	["element_name"] = {
		type = "Model",
		model = "models/mordeciga/mordes/pachkablat.mdl",
		bone = "ValveBiped.Grenade_body",
		rel = "",
		pos = Vector(0, 0, -2.597),
		angle = Angle(-15.195, 180, 180),
		size = Vector(1.34, 1.34, 1.34),
...
SWEP.WElements = {
	["element_name"] = {
		...
		rel = "",
		pos = Vector(3.635, 3.635, -0.519),
		angle = Angle(-26.883, 178.83, 180),
		size = Vector(1.728, 1.728, 1.728),
		color = Color(255, 255, 255, 255),
		surpresslightning = false,
		material = "",
		skin = 0,
...
function SWEP:PrimaryAttack()
	...
	timer.Simple(0.4, function()
		owner:StripWeapon("weapon_ciga_pachka" .. type)
	end)
end
