...
if not file.Exists( 'weapons/csgo_baseknife.lua', 'LUA' ) then
  ...
  print( 'csgo_falchion_fade failed to initialize: csgo_baseknife.lua not found. Did you install the main part?' )
  return 
end
...
SWEP.PrintName      = 'Falchion Knife' .. ' | ' .. 'Fade'
...
SWEP.Icon = "vgui/entities/csgo_falchion_fade.vmt"
