...
if not file.Exists( 'weapons/csgo_baseknife.lua', 'LUA' ) then
  ...
  print( 'csgo_daggers_rustcoat failed to initialize: csgo_baseknife.lua not found. Did you install the main part?' )
  return 
end
...
SWEP.PrintName      = 'Shadow Daggers' .. ' | ' .. 'Rust Coat'
...
SWEP.Icon = "vgui/entities/csgo_daggers_rustcoat.vmt"
