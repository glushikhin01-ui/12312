...
if not file.Exists( 'weapons/csgo_baseknife.lua', 'LUA' ) then
  ...
  print( 'csgo_default_golden failed to initialize: csgo_baseknife.lua not found. Did you install the main part?' )
  return 
end
...
SWEP.PrintName      = 'Default CT Knife' .. ' | ' .. 'Golden'
...
SWEP.Icon = "vgui/entities/csgo_default_golden.vmt"
