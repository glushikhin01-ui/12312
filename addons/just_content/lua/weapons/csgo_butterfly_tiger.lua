...
if not file.Exists( 'weapons/csgo_baseknife.lua', 'LUA' ) then
  ...
  print( 'csgo_butterfly_tiger failed to initialize: csgo_baseknife.lua not found. Did you install the main part?' )
  return 
end
...
SWEP.PrintName      = 'Butterfly Knife' .. ' | ' .. 'Tiger Tooth'
...
SWEP.Icon = "vgui/entities/csgo_butterfly_tiger.vmt"
