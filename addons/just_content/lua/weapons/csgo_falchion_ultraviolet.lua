...
if not file.Exists( 'weapons/csgo_baseknife.lua', 'LUA' ) then
  ...
  print( 'csgo_falchion_ultraviolet failed to initialize: csgo_baseknife.lua not found. Did you install the main part?' )
  return 
end
...
SWEP.PrintName      = 'Falchion Knife' .. ' | ' .. 'Ultraviolet'
...
SWEP.Icon = "vgui/entities/csgo_falchion_ultraviolet.vmt"
