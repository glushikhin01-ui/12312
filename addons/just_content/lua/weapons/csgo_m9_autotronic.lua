...
if not file.Exists( 'weapons/csgo_baseknife.lua', 'LUA' ) then
  ...
  print( 'csgo_m9_autotronic failed to initialize: csgo_baseknife.lua not found. Did you install the main part?' )
  return 
end
...
SWEP.PrintName      = 'M9 Bayonet Knife' .. ' | ' .. 'Autotronic'
...
SWEP.Icon = "vgui/entities/csgo_m9_autotronic.vmt"
