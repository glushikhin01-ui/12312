...
SWEP.Gun = ("rwp_weapon_pist_ot33") -- must be the name of your swep but NO CAPITALS!
...
SWEP.PrintName				= "OTs-33 Pernach"		-- Weapon name (Shown on HUD)	
...
SWEP.ViewModel				= "models/weapons/v_pist_ot33pemac.mdl"	-- Weapon view model
SWEP.WorldModel				= "models/weapons/w_pist_ot33pemac.mdl"	-- Weapon world model
...
SWEP.IronSightsPos = Vector(3.839, 0, 1.72)
SWEP.IronSightsAng = Vector(0, 0, 0)
SWEP.SightsPos = Vector(3.839, 0, 1.72)
SWEP.SightsAng = Vector (0, 0, 0)
SWEP.RunSightsPos = Vector(1.159, 0, 1.44)
SWEP.RunSightsAng = Vector(-9.146, 0, 0)
SWEP.InspectPos = Vector(-6.52, -1.407, 0.72)
SWEP.InspectAng = Vector(-2.814, -49.246, 0)
