...
SWEP.Gun = ("rwp_weapon_sniper_vssk") -- must be the name of your swep but NO CAPITALS!
...
SWEP.PrintName				= "VSSK Vihlop"		-- Weapon name (Shown on HUD)	
...
SWEP.ViewModel				= "models/weapons/v_gho_vks.mdl"	-- Weapon view model
SWEP.WorldModel				= "models/weapons/w_gho_vks.mdl"	-- Weapon world model
SWEP.Base 				= "tfa_scoped_base"
SWEP.Spawnable				= true
SWEP.AdminSpawnable			= true

SWEP.Primary.Sound			= Sound("vks.Single")		-- script that calls the primary fire sound
...
SWEP.IronSightsPos = Vector (-3.241, -5.801, -0.201)
SWEP.IronSightsAng = Vector (0, 0, 0)
SWEP.SightsPos = Vector (-3.241, -5.801, -0.201)
SWEP.SightsAng = Vector (0, 0, 0)
SWEP.RunSightsPos = Vector (1.36, -1, -3.681)
SWEP.RunSightsAng = Vector (-16.601, 44.2, -33.1)
SWEP.InspectPos = Vector(4.239, -2.613, 0.959)
SWEP.InspectAng = Vector(-7.035, 40.101, 0)

sound.Add({
	name = 			"vks.Single",			// <-- Sound Name That gets called for
	channel = 		CHAN_USER_BASE +10,
	volume = 		1.0,
	sound = 			"weapons/vks/fire1.wav"	// <-- Sound Path
})
