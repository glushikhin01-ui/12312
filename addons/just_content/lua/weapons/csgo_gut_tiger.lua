...
if not file.Exists( 'weapons/csgo_baseknife.lua', 'LUA' ) then
  ...
  print( 'csgo_gut_tiger failed to initialize: csgo_baseknife.lua not found. Did you install the main part?' )
  return 
end
...
SWEP.PrintName      = 'Gut Knife' .. ' | ' .. 'Tiger Tooth'
...
SWEP.Icon = "vgui/entities/csgo_gut_tiger.vmt"
