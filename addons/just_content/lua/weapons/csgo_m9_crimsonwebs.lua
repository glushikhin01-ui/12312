...
if not file.Exists( 'weapons/csgo_baseknife.lua', 'LUA' ) then
  ...
  print( 'csgo_m9_crimsonwebs failed to initialize: csgo_baseknife.lua not found. Did you install the main part?' )
  return 
end
...
SWEP.PrintName      = 'M9 Bayonet Knife' .. ' | ' .. 'Crimson Webs'
...
SWEP.Icon = "vgui/entities/csgo_m9_crimsonwebs.vmt"
