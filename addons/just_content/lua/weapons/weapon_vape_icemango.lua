...
SWEP.PrintName = "HQD IceMango"

SWEP.ViewModel = "models/c_arms_i/c_arms_i.mdl"
SWEP.WorldModel = "models/hqd_i/hqd_i.mdl"
...
function SWEP:SecondaryAttack()
	...
	if random == 1 then
		self:EmitSound("ice_mango.wav", 80, pitch + math.Rand(-5,5))
