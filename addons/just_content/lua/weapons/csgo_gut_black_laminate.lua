...
if not file.Exists( 'weapons/csgo_baseknife.lua', 'LUA' ) then
  ...
  print( 'csgo_gut_black_laminate failed to initialize: csgo_baseknife.lua not found. Did you install the main part?' )
  return 
end
...
SWEP.PrintName      = 'Gut Knife' .. ' | ' .. 'Black Laminate'
SWEP.Category       = 'CS:GO Knives'

SWEP.Spawnable      = true
SWEP.AdminSpawnable = true

SWEP.ViewModel      = 'models/weapons/v_csgo_gut.mdl'
...
SWEP.Icon = "vgui/entities/csgo_gut_black_laminate.vmt"
