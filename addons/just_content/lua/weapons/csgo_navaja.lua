...
if not file.Exists( 'weapons/csgo_baseknife.lua', 'LUA' ) then
  ...
  print( 'csgo_flip failed to initialize: csgo_baseknife.lua not found. Did you install the main part?' )
  return 
end
...
SWEP.ViewModel      = 'models/weapons/horizon/v_csgo_navaja.mdl'
SWEP.WorldModel     = 'models/weapons/horizon/w_csgo_navaja.mdl'
...
SWEP.Icon = "vgui/entities/csgo_flip.vmt"
