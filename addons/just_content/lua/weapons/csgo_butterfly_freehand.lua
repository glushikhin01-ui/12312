...
if not file.Exists( 'weapons/csgo_baseknife.lua', 'LUA' ) then
  ...
  print( 'csgo_butterfly_freehand failed to initialize: csgo_baseknife.lua not found. Did you install the main part?' )
  return 
end
...
SWEP.PrintName      = 'Butterfly Knife' .. ' | ' .. 'Freehand'
...
SWEP.Icon = "vgui/entities/csgo_butterfly_freehand.vmt"
