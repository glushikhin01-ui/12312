...
SWEP.Gun = ("rwp_tfa_sniper_svu") -- must be the name of your swep but NO CAPITALS!
...
SWEP.PrintName				= "SVU"		-- Weapon name (Shown on HUD)	
...
SWEP.Primary.Sound			= Sound("Weapons/svu/g3sg1-1.wav")		-- script that calls the primary fire sound
