...
SWEP.Gun = ("rwp_tfa_sniper_svt40") -- must be the name of your swep but NO CAPITALS!
...
SWEP.Primary.Sound			= Sound("Weapons/svt40/g3sg1-1.wav")		-- script that calls the primary fire sound
