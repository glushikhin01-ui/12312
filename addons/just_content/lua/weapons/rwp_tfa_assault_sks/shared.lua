...
SWEP.Gun = ("rwp_weapon_assault_sks") -- must be the name of your swep but NO CAPITALS!
...
sound.Add({
    name = "SKS.StripperOff",
	channel = CHAN_ITEM,
	colume = 1.0,
	sound = "Weapons/sks/sks off.wav"
})
...
sound.Add({
	...
	channel = CHAN_ITEM,
	colume = 1.0,
	sound = "Weapons/sks/sks in.wav"
})

sound.Add({
    name = "SKS.Boltrelease",
	channel = CHAN_ITEM,
	colume = 1.0,
	sound = "Weapons/sks/sks bolt.wav"
})
...
sound.Add({
	...
	channel = CHAN_ITEM,
	colume = 1.0,
	sound = "Weapons/sks/sks draw.wav"
})

SWEP.WElements = {
	["element_name"] = { type = "Model", model = "models/tnb/weapons/w_sks.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(8.831, -0.519, -3.636), angle = Angle(-10.52, 1.169, 180), size = Vector(1.014, 1.014, 1.014), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
