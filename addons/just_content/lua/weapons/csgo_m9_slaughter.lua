...
if not file.Exists( 'weapons/csgo_baseknife.lua', 'LUA' ) then
  ...
  print( 'csgo_m9_slaughter failed to initialize: csgo_baseknife.lua not found. Did you install the main part?' )
  return 
end
...
SWEP.PrintName      = 'M9 Bayonet Knife' .. ' | ' .. 'Slaughter'
...
SWEP.Icon = "vgui/entities/csgo_m9_slaughter.vmt"
