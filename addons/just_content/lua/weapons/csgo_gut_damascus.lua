...
if not file.Exists( 'weapons/csgo_baseknife.lua', 'LUA' ) then
  ...
  print( 'csgo_gut_damascus failed to initialize: csgo_baseknife.lua not found. Did you install the main part?' )
  return 
end
...
SWEP.PrintName      = 'Gut Knife' .. ' | ' .. 'Damascus Steel'
...
SWEP.Icon = "vgui/entities/csgo_gut_damascus.vmt"
