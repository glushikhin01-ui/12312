...
SWEP.Gun = ("rwp_weapon_assault_ak12") -- must be the name of your swep but NO CAPITALS!
...
SWEP.WElements = {
	["models/weapons/w_rif_ak12.mdl"] = { type = "Model", model = "models/weapons/w_rif_ak12.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(2.596, 1, 0), angle = Angle(0, 0, 180), size = Vector(1.014, 1.014, 1.014), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
