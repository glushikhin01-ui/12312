...
if not file.Exists( 'weapons/csgo_baseknife.lua', 'LUA' ) then
  ...
  print( 'csgo_flip_ddpat failed to initialize: csgo_baseknife.lua not found. Did you install the main part?' )
  return 
end
...
SWEP.PrintName      = 'Flip Knife' .. ' | ' .. 'Forest DDPAT'
...
SWEP.Icon = "vgui/entities/csgo_flip_ddpat.vmt"
