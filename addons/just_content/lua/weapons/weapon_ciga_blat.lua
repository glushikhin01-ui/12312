...
-- Cigarette SWEP by Mordestein (based on Vape SWEP by Swamp Onions, Edited and Retuxtured by MurkywateR)
...
SWEP.PrintName = "Marlboro Full Flavors"
...
function SWEP:SecondaryAttack()
	if SERVER then
		...
		if game.SinglePlayer() then
			self:GetOwner():SendLua([[surface.PlaySound("weapons/smg1/switch_single.wav")]])
		end
	else
