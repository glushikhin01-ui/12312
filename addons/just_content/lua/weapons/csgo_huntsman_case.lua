...
if not file.Exists( 'weapons/csgo_baseknife.lua', 'LUA' ) then
  ...
  print( 'csgo_huntsman_case failed to initialize: csgo_baseknife.lua not found. Did you install the main part?' )
  return 
end
...
SWEP.PrintName      = 'Huntsman Knife' .. ' | ' .. 'Case Hardened'
...
SWEP.Icon = "vgui/entities/csgo_huntsman_case.vmt"
