...
if not file.Exists( 'weapons/csgo_baseknife.lua', 'LUA' ) then
  ...
  print( 'csgo_bowie_tiger failed to initialize: csgo_baseknife.lua not found. Did you install the main part?' )
  return 
end
...
SWEP.PrintName      = 'Bowie knife' .. ' | ' .. 'Tiger Tooth'
...
SWEP.Icon = "vgui/entities/csgo_bowie_tiger.vmt"
