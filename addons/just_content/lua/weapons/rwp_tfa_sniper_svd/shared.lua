...
SWEP.Gun = ("rwp_tfa_sniper_svd") -- must be the name of your swep but NO CAPITALS!
...
SWEP.Primary.Sound			= Sound("Weapons/svd/g3sg1-1.wav")		-- script that calls the primary fire sound
