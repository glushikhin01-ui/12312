...
if not file.Exists( 'weapons/csgo_baseknife.lua', 'LUA' ) then
  ...
  print( 'csgo_huntsman_marblefade failed to initialize: csgo_baseknife.lua not found. Did you install the main part?' )
  return 
end
...
SWEP.PrintName      = 'Huntsman Knife' .. ' | ' .. 'Marble Fade'
...
SWEP.Icon = "vgui/entities/csgo_huntsman_marblefade.vmt"
