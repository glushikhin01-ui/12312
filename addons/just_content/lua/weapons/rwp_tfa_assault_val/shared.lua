...
SWEP.Gun = ("rwp_weapon_assault_val") -- must be the name of your swep but NO CAPITALS!
...
SWEP.IronSightsPos = Vector(-2.221, 0, 1.039)
SWEP.IronSightsAng = Vector(1.2, 0, 0)
SWEP.SightsPos = Vector(-2.221, 0, 1.039)
SWEP.SightsAng = Vector(1.2, 0, 0)
SWEP.RunSightsPos = Vector(2.813, 0, 0.519)
SWEP.RunSightsAng = Vector(-8.443, 25.326, 0)
