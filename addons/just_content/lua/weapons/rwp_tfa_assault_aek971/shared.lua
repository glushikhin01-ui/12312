...
SWEP.Gun = ("rwp_weapon_assault_aek971") -- must be the name of your swep but NO CAPITALS!
...
SWEP.Primary.RPM			= 730			-- This is in Rounds Per Minute
SWEP.Primary.ClipSize			= 30		-- Size of a clip
SWEP.Primary.DefaultClip		= 0		-- Bullets you start with
SWEP.Primary.KickUp				= 0.3		-- Maximum up recoil (rise)
SWEP.Primary.KickDown			= 0.23		-- Maximum down recoil (skeet)
...
SWEP.WElements = {
	["models/weapons/w_cst_ak47.mdl"] = { type = "Model", model = "models/weapons/w_rif_aek97.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(0.518, 0.518, 0.518), angle = Angle(-5.844, 0, 180), size = Vector(0.914, 1.014, 1.014), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
