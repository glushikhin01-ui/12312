...
if not file.Exists( 'weapons/csgo_baseknife.lua', 'LUA' ) then
  ...
  print( 'csgo_flip_gamma_doppler failed to initialize: csgo_baseknife.lua not found. Did you install the main part?' )
  return 
end
...
SWEP.PrintName      = 'Flip Knife' .. ' | ' .. 'Gamma Doppler'
...
SWEP.Icon = "vgui/entities/csgo_flip_gamma_doppler.vmt"
