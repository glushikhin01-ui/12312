...
if not file.Exists( 'weapons/csgo_baseknife.lua', 'LUA' ) then
  ...
  print( 'csgo_bowie_boreal failed to initialize: csgo_baseknife.lua not found. Did you install the main part?' )
  return 
end
...
SWEP.PrintName      = 'Bowie knife' .. ' | ' .. 'Boreal Forest'
...
SWEP.Icon = "vgui/entities/csgo_bowie_boreal.vmt"
