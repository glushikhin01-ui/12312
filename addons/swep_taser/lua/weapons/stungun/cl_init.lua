...
hook.Add("HUDPaint", "Tazer", function()
	...
	if STUNGUN.Thirdperson and STUNGUN.AllowSwitchFromToThirdperson and IsValid(LocalPlayer():GetNWEntity("tazerviewrag")) then
		local txt = string.format("", input.LookupBinding("+duck")) --local txt = string.format("Press %s to switch between third and firstperson view.", input.LookupBinding("+duck"))
