...
if A_AM.ActMod.reFix_limpg then

	if not wOS or wOS and not wOS.WoundedLimp then return end
	...
	hook.Add( "CalcMainActivity", "wOS" ..".WoundedLimp.AnimationHook", function( ply, vel )
		if ply:A_ActMod_IsActing() or ply:A_ActMod_GetIsAct() then UndoPlayerCorrect( ply ) return end
	...
	A_AM.ActMod.reFix_limpg_Done = true
end

A_AM.ActMod.reFix_limpg_OK = true