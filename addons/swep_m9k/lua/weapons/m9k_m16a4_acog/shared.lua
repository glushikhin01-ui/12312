...
SWEP.Primary.KickUp			= .22				-- Maximum up recoil (rise)
SWEP.Primary.KickDown			= .22			-- Maximum down recoil (skeet)
SWEP.Primary.KickHorizontal			= .34		-- Maximum up recoil (stock)
...
SWEP.Primary.Spread		= .0013	--define from-the-hip accuracy 1 is terrible, .0001 is exact)
SWEP.Primary.IronAccuracy = .0013 -- ironsight accuracy, should be the same for shotguns
