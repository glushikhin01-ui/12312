...
SWEP.Primary.KickUp				= 3.8				-- Maximum up recoil (rise)
SWEP.Primary.KickDown			= 2.8		-- Maximum down recoil (skeet)
SWEP.Primary.KickHorizontal		= 2.8	-- Maximum up recoil (stock)
