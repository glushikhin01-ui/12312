...
SWEP.Primary.KickUp			= .42				-- Maximum up recoil (rise)
SWEP.Primary.KickDown			= .24			-- Maximum down recoil (skeet)
SWEP.Primary.KickHorizontal			= .42		-- Maximum up recoil (stock)
...
SWEP.Primary.IronAccuracy = .0027 -- ironsight accuracy, should be the same for shotguns
