...
SWEP.Gun = ("m9k_vss") -- must be the name of your swep but NO CAPITALS!
...
SWEP.ViewModel				= "models/weapons/v_vss.mdl"	-- Weapon view model
SWEP.WorldModel				= "models/weapons/w_vss.mdl"	-- Weapon world model 
...
SWEP.Primary.Sound			= Sound("Weapon_vss.Single")		-- Script that calls the primary fire sound
SWEP.Primary.RPM			= 700			-- This is in Rounds Per Minute
SWEP.Primary.ClipSize			= 15		-- Size of a clip
SWEP.Primary.DefaultClip		= 60		-- Bullets you start with
SWEP.Primary.KickUp				= 0.03		-- Maximum up recoil (rise)
SWEP.Primary.KickDown			= 0.0080		-- Maximum down recoil (skeet)
...
SWEP.SightsPos = Vector(-3.4, 0, 1)
SWEP.SightsAng = Vector(0.01, 0.13, 0)
