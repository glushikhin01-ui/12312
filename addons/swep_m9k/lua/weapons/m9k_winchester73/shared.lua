...
SWEP.Primary.KickUp			= .12				-- Maximum up recoil (rise)
...
SWEP.Primary.Spread		= .0045	-- Define from-the-hip accuracy 1 is terrible, .0001 is exact)
SWEP.Primary.IronAccuracy = .00048	-- Ironsight accuracy, should be the same for shotguns
