...
SWEP.Gun = ("m9k_m92beretta_toji") -- must be the name of your swep but NO CAPITALS!
...
SWEP.PrintName				= "M92 Tojitta"		-- Weapon name (Shown on HUD)	
...
SWEP.Primary.DefaultClip		= 900		-- Bullets you start with
SWEP.Primary.KickUp				= 0.000001		-- Maximum up recoil (rise)
SWEP.Primary.KickDown			= 0.000001		-- Maximum down recoil (skeet)
SWEP.Primary.KickHorizontal		= 0.000001		-- Maximum up recoil (stock)
...
SWEP.Primary.Damage		= 70	//base damage, scaled by game
SWEP.Primary.Spread		= 0.000001	//define from-the-hip accuracy 1 is terrible, .0001 is exact)
SWEP.Primary.IronAccuracy = 0.000001 // has to be the same as primary.spread
