...
SWEP.Primary.KickUp				= 0.14		-- Maximum up recoil (rise)
SWEP.Primary.KickDown			= 0.06		-- Maximum down recoil (skeet)
SWEP.Primary.KickHorizontal		= 0.14		-- Maximum up recoil (stock)
