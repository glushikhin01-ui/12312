...
SWEP.Primary.KickUp				= .24				-- Maximum up recoil (rise)
SWEP.Primary.KickDown			= .24			-- Maximum down recoil (skeet)
...
SWEP.Primary.IronAccuracy = .0054 -- ironsight accuracy, should be the same for shotguns
