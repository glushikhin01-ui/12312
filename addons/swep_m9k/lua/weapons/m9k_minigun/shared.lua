...
SWEP.Primary.Spread		= .0181	-- Define from-the-hip accuracy 1 is terrible, .0001 is exact)
SWEP.Primary.IronAccuracy = .0181 -- Ironsight accuracy, should be the same for shotguns
