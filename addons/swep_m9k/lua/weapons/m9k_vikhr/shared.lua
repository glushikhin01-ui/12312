...
SWEP.Primary.KickUp				= 0.19		-- Maximum up recoil (rise)
SWEP.Primary.KickDown			= 0.19		-- Maximum down recoil (skeet)
SWEP.Primary.KickHorizontal		= 0.27		-- Maximum up recoil (stock)
...
SWEP.Primary.IronAccuracy = .0068 -- Ironsight accuracy, should be the same for shotguns
