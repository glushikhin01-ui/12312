...
SWEP.Primary.KickUp				= 0.038		-- Maximum up recoil (rise)
SWEP.Primary.KickDown			= 0.038		-- Maximum down recoil (skeet)
SWEP.Primary.KickHorizontal		= 0.057		-- Maximum up recoil (stock)
...
SWEP.Primary.IronAccuracy = .0058 -- Ironsight accuracy, should be the same for shotguns
