...
SWEP.Primary.KickDown			= 0.22		-- Maximum down recoil (skeet)
SWEP.Primary.KickHorizontal		= 0.22		-- Maximum up recoil (stock)
...
SWEP.Primary.Spread		= .0018	--define from-the-hip accuracy 1 is terrible, .0001 is exact)
SWEP.Primary.IronAccuracy = .0013 -- has to be the same as primary.spread
